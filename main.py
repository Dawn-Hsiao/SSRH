...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='test_accuracy',choices=['test_accuracy','test_embedding'])
    ...
    parser.add_argument('--embedding_epoch', type=int, default=99, help='The adversarial training epoch')
    ...
    parser.add_argument('--mode', type=str, default='test_accuracy', choices=['test_accuracy', 'test_embedding'])

    # Directories.

    parser.add_argument('--image_dir', type=str, default='images/capture/')
    parser.add_argument('--image_val_dir', type=str, default='images/capture/')

    parser.add_argument('--log_dir', type=str, default='logs')
    parser.add_argument('--model_save_dir', type=str, default='models')
    parser.add_argument('--model_name',type=str,default='Encoder_Decoder_Model')
    parser.add_argument('--result_dir', type=str, default='images')
    parser.add_argument('--wmat_dir', type=str, default='images/WatermarkMatrix/w.mat')
